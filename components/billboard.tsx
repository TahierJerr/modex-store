...
const Billboard: React.FC<BillboardProps> = async ({ data, buttonText, buttonLink }) => {
    return (
        ...
        >
            <Image className="hidden sm:block" loading="eager" src={data?.imageUrl} alt="billboard" layout="fill" objectFit="cover" fetchPriority="high" quality={100} priority={true} />
