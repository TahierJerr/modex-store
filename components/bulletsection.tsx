  ...
  return (
    <div className="text-white space-y-4 my-12">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:gird-cols-4 gap-4 bg-black200 rounded-md py-4 px-2">
        ...
        <div className="px-4 py-2">
          <h2 className='text-primary text-2xl font-semibold mb-6 flex items-center'><EuroIcon className="mr-2 w-6 h-6"/>Eerlijke prijzen</h2>
        ...
        <div className="px-4 py-2">
          <h3 className='text-primary text-2xl font-semibold mb-6 flex items-center'><Shield className="mr-2 w-6 h-6"/>Betrouwbare garantie</h3>
