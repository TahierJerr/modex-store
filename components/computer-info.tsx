    ...
    return (
        <div>
            ...
            <div className="flex gap-x-4 flex-col">
                ...
                <p className="mb-2">Memory: {data.memory.name}</p>
                <p className="mb-2">Motherboard: {data.motherboard.name}</p>
                <p className="mb-2">Storage: {data.storage.name}</p>
                <p className="mb-2">PSU: {data.power.name}</p>
                <p className="mb-2">Case: {data.pccase.name}</p>
            </div>
            <hr className="my-4 text-black200"/>
