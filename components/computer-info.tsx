    ...
    return (
        <div>
            ...
            <DeliveryTime deliveryTime={data.deliveryTime} classNames="mb-2" />
                <Button title="Add to cart" onClick={onAddToCart} className="bg-white text-black hover:bg-primary flex items-center w-full rounded-lg justify-center gap-x-2 mt-2 sm:mt-4">
