            ...
            <div className="px-4 sm:px-6 lg:px-8">
                <div className="mx-auto max-w-4xl">
                    <div className="mb-8 md:mb-12 lg:mb-16 text-center">
                        <h2 className="text-3xl sm:text-4xl font-bold tracking-tight text-white">Gaming PC Specifications</h2>
                    ...
                    <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6">
                        {specs.map((spec, index) => (
                            ...
                            >
                            <h3 className="text-base sm:text-lg font-semibold text-white">{spec.title}</h3>
                            <div className="mt-2 flex items-center gap-2">
                                {spec.icon}
                                <p className="text-xs sm:text-sm text-gray-200">{spec.detail}</p>
                            </div>
