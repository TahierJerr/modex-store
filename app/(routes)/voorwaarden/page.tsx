...
export default function Voorwaarden() {
  ...
  <div className="text-white space-y-2 md:space-y-4 lg:space-y-6 xl:space-y-8">
        ...
        <p className="text-lg mb-4">Nederland</p>
        
        <p className="text-lg mb-4">Telefoonnummer: +316 49146060</p>
        ...
        Wanneer de consument gebruik wenst te maken van zijn herroepingsrecht is hij verplicht dit binnen 30 dagen, na ontvangst van het product, kenbaar te maken aan de ondernemer. Het kenbaar maken dient de consument te doen middels het modelformulier of door middel van een e-mail.
        ...
        <h3 className="text-xl font-bold mb-4">Uitsluiting van het herroepingsrecht is slechts mogelijk voor producten:</h3>

        <p className="text-lg mb-4">- Die door de ondernemer tot stand zijn gebracht overeenkomstig specificaties van de consument; dit geldt ook voor onze op maat gemaakte computers;</p>
        <p className="text-lg mb-4">- Die duidelijk persoonlijk van aard zijn;</p>
        <p className="text-lg mb-4">- Die door hun aard niet kunnen worden teruggezonden;</p>
        <p className="text-lg mb-4">- Voor audio- en video-opnamen en computersoftware waarvan de consument de verzegeling heeft verbroken;</p>
        ...
        Wanneer de klant een overeenkomst maakt betaalt hij automatisch dit bedrag dat is betaald is goedgekeurd en hoeft nooit meer bij te betalen.
        Zodra er een fout is gemaakt en de klant heeft iets besteld met dit bedrag krijgt de klant een mail dat er iets fout is gegaan in het systeem en krijgen ze hun geld zo snel mogelijk terug, maximaal 14 dagen.
        ...
        Eventuele gebreken of verkeerd geleverde producten dienen binnen 2 maanden na ontdekking van het gebrek aan de ondernemer schriftelijk of via mail te worden gemeld.
        De garantietermijn van de ondernemer komt overeen met de fabrieksgarantietermijn. De ondernemer is echter te nimmer verantwoordelijk voor de uiteindelijke geschiktheid van de producten voor elke individuele toepassing door de consument, noch voor eventuele adviezen ten aanzien van het gebruik of de toepassing van de producten.
        Als de klant een van onze producten bewerkt of repareert mogen ze dit product nog steeds voor garantie stellen. Wij zullen checken of dit product “garantievaardig” is. Dit betekent dat de reparatie of bewerking van de klant geen gevolgen heeft kunnen doorstaan door hetgeen wat kapot is. Als dit wel het geval is dat de klant iets heeft kapot gemaakt, zullen we het product terugsturen naar de klant en het nieuws doorgeven via mail.
        </p>
