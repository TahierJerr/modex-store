...
export default function Cookies() { 
    ...
    <div className="container mx-auto px-4 md:px-8 lg:px-16 xl:px-32 text-white mt-20">
        ...
        <h2 className="text-2xl font-bold mb-4">Hoe we cookies gebruiken</h2>
        ...
        <h2 className="text-2xl font-bold mb-4">Cookies uitschakelen</h2>
        ...
        <h2 className="text-2xl font-bold mb-4">De cookies die we instellen</h2>
